...
SInventory::SInventory(int w_width, int w_height)
{
...
{
    this->_textures["inventory"] = std::make_shared<sf::Texture>();
    this->_textures["inventory"]->loadFromFile("gui/assets/inventory/inventory.png");
    this->_sprites["inventory"] = std::make_shared<sf::Sprite>();
    ...
    this->_textures["display"] = std::make_shared<sf::Texture>();
    this->_textures["display"]->loadFromFile("gui/assets/inventory/player_display.png");
    this->_sprites["display"] = std::make_shared<sf::Sprite>();
    ...
    this->_textures["trantorian"] = std::make_shared<sf::Texture>();
    this->_sprites["trantorian"] = std::make_shared<sf::Sprite>();
...
void SInventory::createTexts()
{
    ...
    this->_texts["lvl"] = std::make_shared<sf::Text>();
